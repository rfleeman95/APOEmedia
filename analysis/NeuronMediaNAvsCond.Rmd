...
ErrorTable <- as.table(CVrepeated_error_averages)
rownames(ErrorTable)<- c("1 LV", "2 LVs", "3 LVs", "4 LVs", "5 LVs")
colnames(ErrorTable)<- c("Error")
ErrorTable
print("Choose LV with error:")
min(ErrorTable)
